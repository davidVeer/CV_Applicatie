...
public class ProjectDataContainer extends AppCompatActivity {
    ...
    private String[] concrete_project_descriptions_long;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeholder_project_name = getResources().getString(R.string.placeholder_project_name);
        placeholder_project_description_short = getResources().getString(R.string.placeholder_description_short);
        placeholder_project_description_long = getResources().getString(R.string.placeholder_description_long);

        concrete_project_names = getResources().getStringArray(R.array.project_names);
        concrete_project_description_short = getResources().getStringArray(R.array.short_description_projects);
        concrete_project_descriptions_long = getResources().getStringArray(R.array.detailed_description_projects);
    }
